	...
	launch : function() {
		...
		function Editor(height, domID, isReadOnly, editButtonID, labeltitle) {
			...
			var editor = tinyMCE.init({
				...
				plugins : "style,table,noneditable,example,lists,advhr,advimage,advlink,iespell,inlinepopups,media,paste,directionality,nonbreaking,wordcount,advlist,contextmenu,fullscreen,rdface,autolink,spellchecker,pagebreak,layer,save,emotions,insertdatetime,preview,searchreplace,print,fullscreen,visualchars,xhtmlxtras,template",
