...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectSlugAlias'
        db.create_table(u'main_projectslugalias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_projectslugalias_set', to=orm['main.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slug_aliases', to=orm['main.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('main', ['ProjectSlugAlias'])

        # Adding unique constraint on 'ProjectSlugAlias', fields [u'id', 'name']
        db.create_unique(u'main_projectslugalias', [u'id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectSlugAlias', fields [u'id', 'name']
        db.delete_unique(u'main_projectslugalias', [u'id', 'name'])

        # Deleting model 'ProjectSlugAlias'
        db.delete_table(u'main_projectslugalias')
    ...
    models = {
        ...
        'main.projectslugalias': {
            'Meta': {'unique_together': "(('id', 'name'),)", 'object_name': 'ProjectSlugAlias'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_projectslugalias_set'", 'to': "orm['main.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slug_aliases'", 'to': "orm['main.Project']"})
        },
