...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_scan', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Scan.image'
        db.alter_column(u'main_scan', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
